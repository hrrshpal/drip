...
const Add = ({ token }) => {
    ...
    const newLocal = 'w-full max-w-125 border px-3 py-2'
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
            ...
            <div className='w-full'>
                ...
                <input 
                    ...
                    className='w-full max-w-125 border px-3 py-2' 
                    required 
                />
            </div>
            <div className='w-full'>
            ...
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                ...
                <div>
                    ...
                    <input 
                        ...
                        value={price} 
                        type="Number" 
                        className='w-full sm:w-30 px-3 py-2' 
                        placeholder='Price' 
                        required 
                    />
                </div>
            ...
            <button className='bg-black text-white px-4 py-2 rounded-md mt-4' type='submit'>Add Product</button>
        </form>
    )
}
